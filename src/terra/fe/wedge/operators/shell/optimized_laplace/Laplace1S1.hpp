...
static_assert( linalg::OperatorLike< Laplace1S1< float, quadrature::QuadRuleWedge1Point< float > > > );
static_assert( linalg::OperatorLike< Laplace1S1< float, quadrature::QuadRuleWedge6Points< float > > > );
static_assert( linalg::OperatorLike< Laplace1S1< double, quadrature::QuadRuleWedge1Point< double > > > );
static_assert( linalg::OperatorLike< Laplace1S1< double, quadrature::QuadRuleWedge6Points< double > > > );
